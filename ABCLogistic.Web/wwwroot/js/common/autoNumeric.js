        ...
        (function () {
            ...
            var l = function () {
                ...
                f = {
                    ...
                    maximumValue: "999999999999999999999999999999999999999999999999999999999999.99",
                    minimumValue: "-999999999999999999999999999999999999999999999999999999999999.99",
            ...
            x.Spanish = x.French, x.Chinese = x.Japanese,
                function (o) {
                    ...
                    function P(e) {
                        return "object" === ("undefined" == typeof e ? "undefined" : u(e)) && null !== e && !Array.isArray(e)
                    }
                    ...
                    function A(e) {
                        if ("[object Array]" === Object.prototype.toString.call([])) return Array.isArray(e) || "object" === ("undefined" == typeof e ? "undefined" : u(e)) && "[object Array]" === Object.prototype.toString.call(e);
                    ...
                    function D(e) {
                        if ("undefined" == typeof e.key || "Unidentified" === e.key) return String.fromCharCode(this.keyCodeNumber(e));
                        var t = void 0;
                        switch (e.key) {
                            case "Decimal":
                                t = S.NumpadDot;
                    ...
                    function R(e, t, a) {
                        for (var i = new RegExp("[0-9" + a + "-]"), r = 0, n = 0; n < t; n++) i.test(e[n]) && r++;
                        return r
                    }
                    ...
                    function U(e, t, a, i) {
                        var r = a.length,
                            ...
                            o = void 0,
                            l = 0;
                        for (o = 0; o < r && l < n && l < t; o++) (e[l] === a[o] || "." === e[l] && a[o] === i) && l++;
                        return o
                    }
                    ...
                    function Q(e, t, i) {
                        ...
                        if (e = r ? [r[1], r[2], r[3]].join("") : "", "allow" === t.leadingZero || "keep" === t.leadingZero) {
                            var n = "",
                                ...
                                c = l[1],
                                d = u;
                            k(d, t.negativeSignCharacter) && (n = t.negativeSignCharacter, d = d.replace(t.negativeSignCharacter, "")), "" === n && d.length > t.mIntPos && "0" === d.charAt(0) && (d = d.slice(1)), "" !== n && d.length > t.mIntNeg && "0" === d.charAt(0) && (d = d.slice(1)), e = "" + n + d + (a(c) ? "" : t.decimalCharacter + c)
                        }
                    ...
                    function ie(e, i) {
                        ...
                        var u = e.split(i.decimalCharacter),
                            c = s(u, 2),
                            d = c[0],
                            m = c[1];
                        ...
                        if ("" !== i.digitGroupSeparator)
                            for (; l.test(d) ;) d = d.replace(l, "$1" + i.digitGroupSeparator + "$2");
                        if (0 === i.decimalPlacesOverride || a(m) ? e = d : (m.length > i.decimalPlacesOverride && (m = m.substring(0, i.decimalPlacesOverride)), e = d + i.decimalCharacter + m), i.trailingNegative = !1, "p" === i.currencySymbolPlacement)
                            if (n) switch (i.negativePositiveSignPlacement) {
                                case "l":
                            ...
                            } else if (i.showPositiveSign && !o) switch (i.negativePositiveSignPlacement) {
                                case "l":
                    ...
                    function ne(e, t) {
                        ...
                        var l = e.lastIndexOf("."),
                            ...
                            u = s ? e.length - 1 : l,
                            c = e.length - 1 - u;
                        if (c <= t.decimalPlacesOverride) {
                            if (i = e, c < o) {
                                s && (i += t.decimalCharacter);
                                for (var d = "000000"; c < o;) d = d.substring(0, o - c), i += d, c += d.length
                            } else c > o ? i = re(i, o) : 0 === c && 0 === o && (i = i.replace(/\.$/, ""));
                    ...
                    function le(e) {
                        var t = {},
                            ...
                            r = void 0,
                            n = void 0;
                        if (0 === e && 1 / e < 0 && (e = "-0"), e = e.toString(), M(e) ? (e = e.slice(1), t.s = -1) : t.s = 1, a = e.indexOf("."), a > -1 && (e = e.replace(".", "")), a < 0 && (a = e.length), i = e.search(/[1-9]/i) === -1 ? e.length : e.search(/[1-9]/i), r = e.length, i === r) t.e = 0, t.c = [0];
                        else {
                            for (n = r - 1;
                                "0" === e.charAt(n) ; n -= 1) r -= 1;
                            for (r -= 1, t.e = a - i - 1, t.c = [], a = 0; i <= r; i += 1) t.c[a] = +e.charAt(i), a += 1
                        }
                        return t
                    }
                    ...
                    function se(e, t) {
                        ...
                        if (r !== n) return r;
                        var u = r < 0;
                        if (o !== l) return o > l ^ u ? 1 : -1;
                        for (r = -1, o = a.length, l = i.length, n = o < l ? o : l, r += 1; r < n; r += 1)
                            if (a[r] !== i[r]) return a[r] > i[r] ^ u ? 1 : -1;
                        var c = void 0;
                        return c = o === l ? 0 : o > l ^ u ? 1 : -1
                    }
                    ...
                    function ye() {
                        ...
                        if (e.each(n, function (e, t) {
                                "" === t.name || !d.test(t.localName) || c.test(t.type) || t.disabled || !t.checked && m.test(t.type) ? l.push(-1) : (l.push(g), g++)
                            ...
                            return e.each(v, function (t, a) {
                                ...
                                if (i > -1 && o[i] > -1) {
                                    ...
                                    "object" === ("undefined" == typeof s ? "undefined" : u(s)) && (a.value = n.autoNumeric("getLocalized").toString())
                                }
                            }), v
                        }
                        var p = function () {
                            ...
                            return e.each(a, function (t) {
                                ...
                                if (m > -1 && o[m] > -1) {
                                    ...
                                    if ("object" === ("undefined" == typeof g ? "undefined" : u(g)) && null !== d) {
                        ...
                        if ("object" === ("undefined" == typeof p ? "undefined" : u(p))) return p.v
                    }

                    function Se(e, t, a) {
                        var i = t.settingsClone;
                        if ("focusin" === a.type && !e.is(":focus") && "focus" === i.emptyInputBehavior) {
                            ...
                            r = Y(r, i), r = ve(r, i), i.trailingNegative && (r = "-" + r);
                            var n = void 0;
                            i.decimalPlacesShownOnFocus ? (i.decimalPlacesOverride = i.decimalPlacesShownOnFocus, n = ne(i.rawValue, i), e.val(ie(n, i))) : i.scaleDivisor ? (i.decimalPlacesOverride = Number(i.oDec), n = ne(i.rawValue, i), e.val(ie(n, i))) : i.noSeparatorOnFocus ? (i.digitGroupSeparator = "", i.currencySymbol = "", i.suffixText = "", n = ne(i.rawValue, i), e.val(ie(n, i))) : r !== i.rawValue && e.autoNumeric("set", r), t.valueOnFocus = a.target.value, t.lastVal = t.valueOnFocus;
                            var o = ae(t.valueOnFocus, i, !0);
                            null !== o && "" !== o && "focus" === i.emptyInputBehavior && (e.val(o), o === i.currencySymbol && "s" === i.currencySymbolPlacement && Z(a.target, 0, 0))
                        }
                    }
                    ...
                    function Pe(e, t) {
                        ...
                        if (a !== S.Insert) {
                            ...
                            if (e._updateAutoNumericHolderProperties(t), !e._skipAlways(t)) {
                                ...
                                if (r) {
                                    if (e._formatValue(t), t.target.value !== e.lastVal && e.settingsClone.throwInput) Ke("input", t.target), t.preventDefault();
                                    else {
                    ...
                    function Oe(e, t, a) {
                        ...
                        var c = N(i, t),
                            d = void 0;
                        if (d = "." === c ? "." : _e(c, !1, !1, !1), "." !== d && (!w(d) || "" === d)) return void ("error" === t.settings.onInvalidPaste && z("The pasted value '" + i + "' is not a valid paste content."));
                        var m = void 0,
                            h = void 0;
                        ...
                        switch (t.settings.onInvalidPaste) {
                            ...
                            case "replace":
                                ...
                                for (var C = le(t.settings.minimumValue), O = le(t.settings.maximumValue), x = p, V = 0, A = b; V < d.length && (A += d[V], p = A + P, B(p, C, O)) ;) x = p, V++;
                            ...
                            default:
                                ...
                                else if ("" === P) m = G(R(r, n, t.settings.decimalCharacter)) + d.length;
                                else {
                        ...
                        if (!w(p) || "" === p) return void ("error" === t.settings.onInvalidPaste && z("The pasted value '" + i + "' would result into an invalid content '" + p + "'."));
                        var q = !1,
                            W = !1;
                        try {
                        ...
                        var J = void 0;
                        if (q) switch (t.settings.onInvalidPaste) {
                            case "clamp":
                                if (W) {
                    ...
                    function Ve(e, t, a) {
                        ...
                        if (t) {
                            var n = a.val(),
                                o = Ie(n, e);
                            if (e.formatOnPageLoad && "" !== n && i(a.attr("value"))) isNaN(o) || 1 / 0 === o ? z("The value [" + n + "] used in the input is not a valid value autoNumeric can work with.") : (a.autoNumeric("set", o), r = !1);
                            ...
                            if ("" === n) switch (e.emptyInputBehavior) {
                                case "focus":
                                    r = !1;
                                    break;
                                case "always":
                    ...
                    function Ae(e) {
                        if (t(e.negativePositiveSignPlacement))
                            if (a(e) || !i(e.negativePositiveSignPlacement) || i(e.currencySymbol)) e.negativePositiveSignPlacement = "l";
                    ...
                    function Te(e) {
                        t(e.decimalPlacesOverride) && (e.decimalPlacesOverride = W(e.minimumValue, e.maximumValue)), e.oDec = String(e.decimalPlacesOverride), e.decimalPlacesOverride = Number(e.decimalPlacesOverride)
                    }
                    ...
                    function Ee(i, r) {
                        ...
                        if (!n && t(i) || Me(i), n || a(o)) {
                            ...
                            return Le(o), Ae(o), o.negativeSignCharacter = o.minimumValue < 0 ? "-" : "", o.positiveSignCharacter = o.maximumValue >= 0 ? "+" : "", q(r, o), Fe(o), Te(o), De(o), Be(o), g(o, !1), me(o), r.data("autoNumeric", o), o
                        }
                        return null
                    }
                        ...
                        return l(t, [{
                            ...
                            value: function (e, t) {
                                var a = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                                    ...
                                    n = ue(this.newValue, i),
                                    o = s(n, 2),
                                    l = o[0],
                                    u = o[1],
                                    c = r[0].length;
                                if (this.newValue = r.join(""), l && u) {
                                    this.newValue = oe(this.newValue, i, a);
                                    var d = k(this.newValue, ",") ? this.newValue.replace(",", ".") : this.newValue;
                                    return "" === d || d === i.negativeSignCharacter ? i.rawValue = "zero" === i.emptyInputBehavior ? "0" : "" : i.rawValue = ve(d, i), c > this.newValue.length && (c = this.newValue.length), 1 === c && "0" === r[0] && "deny" === i.leadingZero && (c = "" === r[1] || "0" === r[0] && "" !== r[1] ? 1 : 0), this.value = this.newValue, this._setCaretPosition(c, !1), !0
                                }
                                return l ? u || this.$that.trigger("autoNumeric:maxExceeded") : this.$that.trigger("autoNumeric:minExceeded"), !1
                            }
                        }, {
                            ...
                            key: "_skipAlways",
                            value: function (e) {
                                if ((e.ctrlKey || e.metaKey) && "keyup" === e.type && !a(this.valuePartsBeforePaste) || e.shiftKey && this.eventKeyCode === y.Insert) return this._checkPaste(), !1;
                                if (this.eventKeyCode >= y.F1 && this.eventKeyCode <= y.F12 || this.eventKeyCode >= y.Windows && this.eventKeyCode <= y.RightClick || this.eventKeyCode >= y.Tab && this.eventKeyCode < y.Space || this.eventKeyCode < y.Backspace && (0 === e.which || e.which === this.eventKeyCode) || this.eventKeyCode === y.NumLock || this.eventKeyCode === y.ScrollLock || this.eventKeyCode === y.Insert || this.eventKeyCode === y.Command) return !0;
                                ...
                                if (this.selection.length) {
                                    ...
                                    if (t = o[0], a = o[1], "" === t && "" === a && (e.throwInput = !1), ("p" === e.currencySymbolPlacement && "s" === e.negativePositiveSignPlacement || "s" === e.currencySymbolPlacement && ("l" === e.negativePositiveSignPlacement || "r" === e.negativePositiveSignPlacement)) && L(this.value)) {
                                        var l = this._processCharacterDeletionIfTrailingNegativeSign([t, a]),
                                            u = s(l, 2);
                                        t = u[0], a = u[1]
                                    } else this.eventKeyCode === y.Backspace ? t = t.substring(0, t.length - 1) : a = a.substring(1, a.length)
                                }
                            ...
                            value: function (t) {
                                ...
                                if (("" === i.digitGroupSeparator || "" !== i.digitGroupSeparator && !k(r, i.digitGroupSeparator)) && ("" === i.currencySymbol || "" !== i.currencySymbol && !k(r, i.currencySymbol))) {
                                    var u = r.split(i.decimalCharacter),
                                        c = s(u, 1),
                                        d = c[0],
                                        m = "";
                                ...
                                if (h) {
                                    ...
                                    for (var p = 0; p < v.length; p++) v[p].match("\\d") || (v[p] = "\\" + v[p]);
                        ...
                        Ue = {
                            ...
                            destroy: function () {
                                return e(this).each(function () {
                                    ...
                                    "object" === ("undefined" == typeof t ? "undefined" : u(t)) && (e.val(""), fe(e[0], t, "wipe"), e.removeData("autoNumeric"), e.off(".autoNumeric"))
                                })
                            },
                            wipe: function () {
                                return e(this).each(function () {
                                    var e = ce(this),
                                        t = e.data("autoNumeric");
                                    "object" === ("undefined" == typeof t ? "undefined" : u(t)) && (e.val(""), t.rawValue = "", fe(e[0], t, "wipe"))
                                })
                            },
                            update: function (t) {
                                return e(this).each(function () {
                                    var e = ce(this),
                                        a = e.autoNumeric("get"),
                                        i = Ee(t, e, !0);
                                    if (de(e, i, !0), "" !== e.val() || "" !== e.text()) return e.autoNumeric("set", a)
                                })
                            },
                            set: function (t) {
                                return e(this).each(function () {
                                    if (null !== t && !a(t)) {
                                        ...
                                        "object" !== ("undefined" == typeof i ? "undefined" : u(i)) && z('Initializing autoNumeric is required prior to calling the "set" method.'), i.trailingNegative = !1;
                            ...
                            unSet: function () {
                                return e(this).each(function () {
                                    var e = ce(this),
                                        t = e.data("autoNumeric");
                                    "object" === ("undefined" == typeof t ? "undefined" : u(t)) && (t.hasFocus = !0, e.val(e.autoNumeric("getLocalized")))
                                })
                            },
                            reSet: function () {
                                return e(this).each(function () {
                                    var e = ce(this),
                                        t = e.data("autoNumeric");
                                    "object" === ("undefined" == typeof t ? "undefined" : u(t)) && e.autoNumeric("set", e.val())
                                })
                            },
                            get: function () {
                                var e = ce(this),
                                ...
                                "object" !== ("undefined" == typeof a ? "undefined" : u(a)) && z('Initializing autoNumeric is required prior to calling the "get" method.');
                                var i = "";
                                if (t ? i = e.eq(0).val() : V(e.prop("tagName").toLowerCase(), a.tagList) ? i = e.eq(0).text() : z('The "<' + e.prop("tagName").toLowerCase() + '>" tag is not supported by autoNumeric'), a.decimalPlacesShownOnFocus || a.scaleDivisor) i = a.rawValue;
                                else {
                                    var r = L(i);
                                    if (!/\d/.test(i) && "focus" === a.emptyInputBehavior) return "";
                    ...
                    e.fn.autoNumeric = function (e) {
                        ...
                        return "object" !== ("undefined" == typeof e ? "undefined" : u(e)) && e ? void z('Method "' + e + '" is not supported by autoNumeric') : Ue.init.apply(this, [e])
                    }, m = function () {
                        return f
                    }, e.fn.autoNumeric.defaults = f, h = function () {
                        return x
                    }, e.fn.autoNumeric.lang = x, c = function (i) {
                    ...
                    }, e.fn.autoFormat = c, d = function (t, i) {
                        if (a(t) || null === t) return null;
                        if (w(t)) return Number(t);
                        (A(t) || P(t)) && z("A number or a string representing a number is needed to be able to unformat it, [" + t + "] given.");
                        var r = e.extend({}, f, {
                            strip: !1
                        }, i),
